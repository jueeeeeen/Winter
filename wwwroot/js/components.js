      ...
      this.innerHTML = `
        ...
        activity.host.gender
                    ...
                    <div class="act-card-member">${
                      activity.participants_count + "/" + activity.max_member
                    }</div>
                </div>
                ...
                <ul class="act-card-tags-container">
                    ${Object.entries(activity.requirement)
                      .map(
                        ([type, value]) =>
                          `<li>
...
class HostListItem extends HTMLElement {
  constructor() {
    super();
    this.innerHTML = `<li class="radial-blue-bg member-list-item shadow">
            <div class="member-list-item-profile">
                <img src="../../assets/profile-g.png">
            </div>
            <span class="member-list-item-name">Peerawat Ingkhasantatikul</span>
...
class PendingListItem extends HTMLElement {
  constructor() {
    super();
    this.innerHTML = `<li class="w-bb-bb pending-member-item">
